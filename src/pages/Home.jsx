...
import happyStartupImg from "../assets/images/Happy-startup.png";
import retosImg from "../assets/images/retos.png";
  ...
  return (
    <div className="flex flex-col items-center gap-16 w-full">
      ...
      >
        ...
        <p className="mt-4 text-xl text-gray-300">Bienvenido soy Felipe Alfonso Oyola</p>
      </motion.div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-10 max-w-7xl">
        ...
        <motion.div
          ...
          className="bg-gray-800 bg-opacity-50 p-6 rounded-2xl border border-cyan-500 shadow-xl text-center"
        >
          <img
            src={timelineImg}
            alt="Timeline"
          ...
          />
          <h2 className="text-2xl font-semibold text-cyan-300 mt-4">
            Mi Timeline
          </h2>
          <p className="text-gray-400 mt-2">Explora mi línea de tiempo personal.</p>
          <Link
            to="/timeline"
            className="mt-4 inline-block bg-cyan-600 px-4 py-2 rounded-lg hover:bg-cyan-700"
          >
            Ver Timeline
          </Link>
        </motion.div>
        ...
        <motion.div
          whileHover={{ scale: 1.05 }}
          className="bg-gray-800 bg-opacity-50 p-6 rounded-2xl border border-purple-500 shadow-xl text-center"
        >
          <img
            src={happyStartupImg}
            alt="Happy Startup"
          ...
          <Link
            to="/happy-canvas"
            className="mt-4 inline-block bg-purple-600 px-4 py-2 rounded-lg hover:bg-purple-700"
          >
            Ver Canvas
          </Link>
        </motion.div>
        ...
        <motion.div
          whileHover={{ scale: 1.05 }}
          className="bg-gray-800 bg-opacity-50 p-6 rounded-2xl border border-pink-500 shadow-xl text-center"
        >
          <img
            src={retosImg}
            alt="Retos"
          ...
          <Link
            to="/retos"
            className="mt-4 inline-block bg-pink-600 px-4 py-2 rounded-lg hover:bg-pink-700"
          >
            Ver Retos
          </Link>
        </motion.div>
